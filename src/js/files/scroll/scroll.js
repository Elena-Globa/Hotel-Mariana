...
export function headerScroll() {
	...
	console.log('getItemCoords', getItemTopCoord );
	const getItemTopDocumentCoord = getItemTopCoord + window.pageYOffset;
	console.log('getItemTopDocumentCoord1', getItemTopDocumentCoord);
	const startPoint = header.dataset.scroll ? header.dataset.scroll : 1;
	const startPointTwo = getItemTopDocumentCoord;
	...
	document.addEventListener("windowScroll", function (e) {
		...
		if (scrollTop >= startPoint) {
			...
			if (scrollTop >= startPointTwo) {
				!header.classList.contains('_header-scroll-two') ? header.classList.add('_header-scroll-two') : null;	
			...
			header.classList.contains('_header-scroll-two') ? header.classList.remove('_header-scroll-two') : null;
			if (headerShow) {
				header.classList.contains('_header-show') ? header.classList.remove('_header-show') : null;
			}
		}
